    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('command', 'Command Staff'), ('security', 'Security Personnel'), (
                    'admin', 'Administrative Staff'), ('standard', 'Standard User')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('login_method', models.CharField(choices=[('Password', 'Password'), (
                    'Face Recognition', 'Face Recognition'), ('2FA', 'Two-Factor Authentication')], max_length=20)),
                ('status', models.CharField(choices=[
                 ('Success', 'Success'), ('Failed', 'Failed')], max_length=10)),
