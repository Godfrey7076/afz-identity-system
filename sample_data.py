...
def create_sample_data():
    print("🚀 Creating sample data for Air Force Zimbabwe Identity System...")
    ...
    for i, data in enumerate(personnel_data):
        ...
        if created:
            ...
            print(f"   Unit: {person.unit}")
            print(f"   Service Number: {person.service_number}")
            print(f"   Security Number: {id_record.security_number}")
            print(f"   Security Clearance: {person.security_clearance}")
            print("")
    ...
    for unit in units:
        ...
        print(f"   {unit}: {count} personnel")

    print(f"\n🎖️  RANK DISTRIBUTION:")
    ranks = Person.objects.values_list('rank', flat=True).distinct()
    for rank in sorted(ranks):
        count = Person.objects.filter(rank=rank).count()
        print(f"   {rank}: {count} personnel")

    print(f"\n📊 OVERALL STATISTICS:")
    print(f"   Total Personnel: {Person.objects.count()} records")
    print(f"   Total ID Records: {IDRecord.objects.count()} records")
    print(f"   Total Security Logs: {SecurityLog.objects.count()} logs")
    print(f"\n🔐 Security numbers follow: AFZ-XXXX-XXXX-XXXX format")
    print(f"🎖️  Military IDs follow: AFZ-XX-XXXX format")
    print(f"\n🏛️  UNITS INCLUDED:")
    print(f"   • Flying Wing")
    print(f"   • Regiment Dog Section")
    print(f"   • Provost Section")
    print(f"   • Radios Section")
    print(f"\n⚔️  RANKS INCLUDED (in order):")
    print(f"   • Sergeant")
    print(f"   • Flight Sergeant")
    print(f"   • Master Sergeant")
    print(f"   • Air Lieutenant")
    print(f"   • Flight Lieutenant")
    print(f"   • Squadron Leader")
